...
//Прикрепление пользователя к публикации
Contract.hasMany(Finance_report)
Finance_report.belongsTo(Contract)
...
module.exports = {
  ...
  Type_file,
  File,
  Publication_views, Reason_for_complaint, Favorites, Contract,
